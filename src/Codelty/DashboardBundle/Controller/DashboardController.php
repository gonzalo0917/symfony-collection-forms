...
use Codelty\DashboardBundle\Entity\Dashboard;
use Codelty\DashboardBundle\Entity\Filters;
use Codelty\DashboardBundle\Form\DashboardType;
...
class DashboardController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CodeltyDashboardBundle:Dashboard')->findAll();
     ...
     * @Method("POST")
     * @Template("CodeltyDashboardBundle:Dashboard:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CodeltyDashboardBundle:Dashboard')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("CodeltyDashboardBundle:Dashboard:edit.html.twig")
     */
